...
for (const templateName of templateNames) {
  ...
  // Pi note: terminal.local allow-list is a legacy Codex Work Mode requirement.
  // Accept it when present (Sites handoff) but do not fail Pi-local templates without it.
  if (/allowedHosts:/u.test(viteConfig)) {
