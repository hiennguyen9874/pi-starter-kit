...
If the user asked to be **grilled** on an existing plan, the confirmed statement of intent should also capture the plan decisions that survived questioning and any unresolved decision branches.
