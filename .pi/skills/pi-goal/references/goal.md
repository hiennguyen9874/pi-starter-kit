...
- Likely misfire: <how `/goal` could appear successful while solving the wrong problem>
...
5. Use Scout, Judge, Worker, or PM behavior according to the task.
...
9. If a problem, suggestion, or follow-up should become a repo artifact, create an approved issue/PR or ask the operator whether to create one.
