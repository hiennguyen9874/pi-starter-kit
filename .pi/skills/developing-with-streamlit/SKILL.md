...
description: "Use when creating, editing, debugging, styling, theming, optimizing, or deploying Streamlit apps, including st.* APIs, app.py dashboards, widgets, CSS/theme work, custom components, st.components.v2, packaged components, pyproject.toml, asset_dir, or CCv2."
---
