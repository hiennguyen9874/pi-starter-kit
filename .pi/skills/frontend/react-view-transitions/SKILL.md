...
description: Use when implementing React View Transition API animations, including page transitions, route changes, shared elements, enter/exit animations, list reorder, directional navigation, Next.js integration, or mentions of startViewTransition, ViewTransition, or transition types.
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
