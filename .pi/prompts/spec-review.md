---
description: Run phase 1 spec alignment review against requirements, plan, or design
skills:
  - code-reviewer
...
Determine whether implemented code matches requested behavior, plan, requirements, acceptance criteria, or task intent. Identify deviations, missing scope, and unjustified changes. Produce a structured spec alignment report.

## Context

Inputs may include any of:
- Design or plan file path
...
- Read all provided requirements, plans, and design documents before inspecting code.
...
- Confirm every plan deviation is tied to an explicit plan statement.
- Re-check that no requirement was evaluated from memory alone.

## Done Criteria

- Report is complete with all required sections.
- All requirement mismatches, plan deviations, and scope issues are identified and classified.
